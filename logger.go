...
func WithLevel(level Level) Option       { return func(l *Logger) { l.SetLevel(int(level)) } }
func WithStacktrace(level Level) Option  { return func(l *Logger) { l.SetStacktraceLevel(int(level)) } }
...
func (l *Logger) Enabled(level Level) bool {
	return l.Level() <= int(level) || int(level) == 0
}

func (l *Logger) StacktraceLevel() int {
	return int(l.stacktraceLevel.Load())
}
...
// paths it will be 2.
func (l *Logger) Write(calldepth int, level Level, s string) error {
...
func (l *Logger) write(calldepth int, level Level, appendOutput func([]byte) []byte) error {
