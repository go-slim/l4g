...
func TestSimpleHandler_Handle(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			wantContain: []string{"TRC", "trace message"},
		},
		{
			name:        "debug level",
			level:       LevelDebug,
			message:     "debug message",
			wantContain: []string{"DBG", "debug message"},
		},
		{
			name:        "info level",
			level:       LevelInfo,
			message:     "info message",
			wantContain: []string{"INF", "info message"},
		},
		{
			name:        "warn level",
			level:       LevelWarn,
			message:     "warn message",
			wantContain: []string{"WRN", "warn message"},
		},
		{
			name:        "error level",
			level:       LevelError,
			message:     "error message",
			wantContain: []string{"ERR", "error message"},
		},
		{
			name:        "panic level",
			level:       LevelPanic,
			message:     "panic message",
			wantContain: []string{"PNL", "panic message"},
		},
		{
			name:        "fatal level",
			level:       LevelFatal,
			message:     "fatal message",
			wantContain: []string{"FTL", "fatal message"},
		},
	}
